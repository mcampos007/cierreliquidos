            ...
            <div class="team">
                ...
                <div class="row ">
                    @if(auth()->user()->role=="admin")
                        <a href="{{ url('/admin/surtidors/create')}}" class="btn btn-primary btn-round">
                    @else
                            ...
                            <tr>
                               ...
                               <td class="text-center">{{ $surtidor->lectura_actual }}</td>
                                ...
                                <td class="td-actions text-right">        
                                    <form method="post" action="{{ url('/admin/surtidors/'.$surtidor->id)}}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE')}}
                                        
                                        <a href=" {{ url('/admin/surtidors/'.$surtidor->id.'/edit')}}" type="button" rel="tooltip" title="Editar" class="btn btn-success btn-simple btn-xs">

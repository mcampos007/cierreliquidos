...
@section('content')
    ...
    <div class="main main-raised">
        <div class="container">
            <div class="col-md-8">
                <h2 class="title text-center">Registrar Nuevo Turno</h2>
                @if ($errors->any())
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                ...
                                <select name="turno" id="turno">
                                    <option value="NOCHE"
                                        {{ (old('turno') ?? $turno->turno) === 'NOCHE' ? 'selected' : '' }}>Noche
                                    </option>
                                    <option value="MAÑANA"
                                        {{ (old('turno') ?? $turno->turno) === 'MAÑANA' ? 'selected' : '' }}>Mañana
                                    </option>
                                    <option value="TARDE"
                                        {{ (old('turno') ?? $turno->turno) === 'TARDE' ? 'selected' : '' }}>Tarde
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control datepicker " placeholder="Seleccionar Fecha" name="fecha"
